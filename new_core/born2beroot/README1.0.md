...
## Tools Used
* **Debian 13.3.0** - Operating System
* **Oracle VM VirtualBox** - Virtualization
* **Google Gemini**: Provided technical logic auditing, security hardening advice, and script optimization to meet the project's mandatory requirements.
* **GitHub Copilot**: Assisted with documentation structure and README formatting.
...
2. [Design Choices](#design-choices)
   ...
   - [Tools and Customizations](#tools-and-customizations)
3. [Setup Guide](#setup-guide)
4. [Evaluation Checklist](#evaluation-checklist)
   - [Comparison Topics](#comparison-topics)
...
**aptitude vs apt:**
- **apt**: Modern command-line interface, simpler and more user-friendly, recommended for most users
- **aptitude**: Higher-level package manager with ncurses interface, better dependency resolution, can suggest solutions to conflicts
- Both use the same underlying APT library

**UFW vs firewalld:**
- **UFW (Uncomplicated Firewall)**: 
  - Debian/Ubuntu default
  - Simple command syntax: `ufw allow 4242`
  - Profile-based configuration
  - Frontend for iptables
- **firewalld**: 
  - RHEL/CentOS/Rocky default
  - Zone-based configuration
  - Dynamic firewall with runtime/permanent configs
